...
public class RecipeGroupManagerSingleTest {
    ...
    public void testGroupIdBasedRecipe() {
        ...
        {
            Gav req = new Gav("io.quarkus.security", "quarkus-security", "1.0");
            List<RecipeFile> results = manager.lookupScmInformation(req);
            org.assertj.core.api.Assertions.assertThat(results).hasSize(1);
            RecipeFile result = results.get(0);
    ...
    public void testVersionOverride() {
        ...
        {
            Gav req = new Gav("io.quarkus", "quarkus-core", "0.9");
            List<RecipeFile> results = manager.lookupScmInformation(req);
            org.assertj.core.api.Assertions.assertThat(results).hasSize(1);
            RecipeFile result = results.get(0);
            Assertions.assertEquals("https://github.com/stuartwdouglas/quarkus.git",
    ...
    public void testArtifactAndVersionOverride() {
        ...
        {
            Gav req = new Gav("io.quarkus", "quarkus-gizmo", "0.9");
            List<RecipeFile> results = manager.lookupScmInformation(req);
            org.assertj.core.api.Assertions.assertThat(results).hasSize(1);
            RecipeFile result = results.get(0);
            Assertions.assertEquals("https://github.com/stuartwdouglas/gizmo.git",
    ...
    @Test
    public void testArtifactLZ4() throws IOException {
        {
            Gav req = new Gav("org.lz4", "lz4", "1.8.0");
            List<RecipeFile> results = manager.lookupScmInformation(req);
            org.assertj.core.api.Assertions.assertThat(results).hasSize(1);
            RecipeFile scmLookup = results.get(0);
        ...
        {
            Gav req = new Gav("org.lz4", "lz4-pure-java", "1.8.0");
            List<RecipeFile> results = manager.lookupScmInformation(req);
            org.assertj.core.api.Assertions.assertThat(results).hasSize(1);
            RecipeFile scmLookup = results.get(0);
            ScmInfo result = BuildRecipe.SCM.getHandler().parse(scmLookup.recipeFile());
